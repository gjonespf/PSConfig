...
File_F0_NotFound = The specified file '{0}' was not found.

CannotLoad_F0_Data_F1 = Unable to load {0} data from file '{1}'.

ClearingSources = Clearing Configuration Sources.
